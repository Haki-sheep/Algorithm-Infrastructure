...
namespace Unity.Pipeline.Tests.Editor.Materials
{
    ...
    class MaterialCommandsTests
    {
        ...
        {
            // Unity 6 exposes Material.rawRenderQueue publicly; on Unity 2022 it is internal, so reflect.
            var raw = typeof(Material).GetProperty("rawRenderQueue", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic);
